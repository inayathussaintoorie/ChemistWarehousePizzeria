    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Capricciosa", "Cheese, Ham, Mushrooms, Olives" },
                    { 2, "Mexicana", "Cheese, Salami, Capsicum, Chilli" },
                    { 3, "Margherita", "Cheese, Spinach, Ricotta, Cherry Tomatoes" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Preston Pizzeria" },
                    { 2, 2, "Southbank Pizzeria" }
                });
